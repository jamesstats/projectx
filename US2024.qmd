...
#plot
ggplot(plmean,aes(x=end_date, y=pct_04da, color=candidates))+
  geom_jitter()+
...
| EndDate     | Candidates | Head to Head | with Third Parties |
|:------------|:-----------|:------------:|:------------------:|
| Mar 2, 2024 | **Biden**  |     45%      |        44%         |
| Mar 2, 2024 | **Trump**  |    46.8%     |        45%         |
