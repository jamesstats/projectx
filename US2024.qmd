...
geom_vline(xintercept = as.POSIXct(as.Date(c("2023-10-07","2024-05-30","2024-06-27",'2024-07-21','2024-08-23'))), linetype=4)+
...
|:-------------|:------:|:-----:|:------------:|:------------------------:|
| Aug 30, 2024 | 48.4%  | 44.8% | +3.6% Harris |     **Head-to-Head**     |
| Aug 30, 2024 | 48.2%  | 44.8% | +3.4% Harris | *with* **Third-Parties** |
