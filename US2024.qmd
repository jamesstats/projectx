...
2024 national polling beginning of October between Biden vs Trump and with third parties candidates included and continuation after Biden exit.
...
labs(x="",y="",color="",caption = "Sources:(3DAWMA)AtlasIntel,CBS,Civiqs,CNBC,CNN,Cygnal,Emerson,FoxNews,JL Partners\nMarist,Marquette,NBCNews,NYT/Siena,TippInsights,USAToday,Quinnipiac\njamesstats.github.io/projectx")+
    scale_colour_manual(values = c('#0099ff','#0099ff','yellow','green', '#ff6666','purple'))+
...
|:-------------|:-----:|:-----:|:-------:|:-----------:|:------------------------:|
| Jul 14, 2024 | 40.6% | 44.3% |         | +4.3% Trump |     **Head-to-Head**     |
| Jul 14, 2024 | 42.3% | 47.3% |   7%    | +5.0% Trump | *with* **Third-Parties** |
