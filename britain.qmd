...
ggplot(gbmean, mapping = aes(x=end_date, y=pct_02da, color=Party))+
  ...
  scale_colour_manual(values = c('blue','green','tomato',"orange","cyan","yellow"))+
  scale_y_continuous(limits = c(min(0),max(50)))+ 
  theme_bw()+
  labs(title = 'Westminster Voting Intention',caption = 'source::wikipedia\njamesstats.github.io/projectx',x='',y='',color='')+
...
|-------------|:-----:|:-----------:|:-------:|:----:|:------:|:------:|
| Apr 28.2024 |  22%  |  **43.3%**  |   10%   | 2.8% |  6.3%  | 12.5%  |
